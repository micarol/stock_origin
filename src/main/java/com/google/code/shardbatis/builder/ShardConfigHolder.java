...
public class ShardConfigHolder {
	...
	private List<String> strategyTable = new ArrayList<String>();
	...
	public void register(String table, ShardStrategy strategy) {
		...
		this.strategyTable.add(table.toLowerCase());	// add by Frankie 2013-02-20
	}
	 ...
	 * @return
	 */
	public List<String> getStrategyTable() {
